...
if [ ! -d metadata/Libri1Mix ]; then
  echo GENERATING METADATA FOR 1 SPEAKERS
  python3 scripts/create_librimix_metadata.py --librispeech_dir $storage_dir/LibriSpeech --librispeech_md_dir metadata/LibriSpeech --wham_dir $storage_dir/wham_noise --wham_md_dir metadata/Wham_noise --metadata metadata/Libri1Mix --n_src 1
